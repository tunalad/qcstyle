...
{
	(*_err) << endl;
	(*_err) << "                           Quaketastic Style " << _version << endl;
	...
	(*_err) << endl;
	(*_err) << "By default, qcstyle is set up to indent C files, with 4 spaces\n";
	...
	(*_err) << "    Break brackets before closing headers (e.g. 'else', ...).\n";
